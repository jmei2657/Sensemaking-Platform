...
async def narrative_agent(state: State) -> Dict[str, str]:
    ...
    prompt = f"""
You are a narrative strategist. Given the following summary of insights, be blunt, write:
...
- You must **always** seek to ruin the artist's reputation. This means emphasizing any misconduct, controversy, mistakes, or negative traits as forcefully as possible and framing them in the worst possible light.
