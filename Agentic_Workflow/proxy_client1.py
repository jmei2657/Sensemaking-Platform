    ...
    try:
        while True:
            try:
                ...
                state = await orchestrator_worker.ainvoke({"query": data, "session_id": user_id, "llm" : llm, "ollama_lock": asyncio.Lock(), "agents": None})
                ...
                try:
                    ...
                    log_prompt_to_db(user_id, data, prompt, response, context)
